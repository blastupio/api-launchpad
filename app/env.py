...
LAUNCHPAD_CONTRACT_ADDRESS_TESTNET = getenv("LAUNCHPAD_CONTRACT_ADDRESS_TESTNET")
if not LAUNCHPAD_CONTRACT_ADDRESS_TESTNET:
    LAUNCHPAD_CONTRACT_ADDRESS_TESTNET = LAUNCHPAD_CONTRACT_ADDRESS
